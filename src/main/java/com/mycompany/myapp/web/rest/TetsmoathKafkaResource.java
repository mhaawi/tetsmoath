...
@RestController
@RequestMapping("/api/tetsmoath-kafka")
public class TetsmoathKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TetsmoathKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TetsmoathKafkaResource(KafkaProperties kafkaProperties) {
